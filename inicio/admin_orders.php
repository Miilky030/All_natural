...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Monto total : <span>$<?= $fetch_orders['total_price']; ?>/-</span> </p>
         ...
         <form action="" method="POST">
            ...
            <div class="flex-btn">
               ...
               <a href="admin_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('¿Borrar esta orden?');">Borrar</a>
            </div>
         </form>
      </div>
      <?php
         ...
         echo '<p class="empty">¡Ningún pedido realizado!</p>';
      }
      ?>
