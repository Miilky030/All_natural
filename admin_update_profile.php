...
<head>
   ...
   <title>Actualizar perfil de admin</title>

   <!-- font awesome cdn link  -->
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">

   <!-- custom css file link  -->
   <link rel="stylesheet" href="proyect/css/components.css">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Ingresar anterior contraseña" class="box">
            <span>Nueva contraseña :</span>
            <input type="password" name="new_pass" placeholder="Ingresar nueva contraseña" class="box">
