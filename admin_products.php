...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('¿Desea eliminar este producto?');">Borrar</a>
      </div>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">¡Ningún producto añadido!</p>';
   }
   ?>
